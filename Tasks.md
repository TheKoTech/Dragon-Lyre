...
- [ ] Полоса прогресса, показывающее время до старта звука


## ### Общие

- [ ] Определить единый формат аудио файлов - .ogg, .mp3...<br><br>@{2022-11-26}
- [ ] [[Подготовить датасет со звуками]]<br><br>@{2022-12-09}


## ### <div style='color: #297bff'>Задачи Вовы</div>

- [ ] Окно добавления звуков из папки<br><br>@{2022-11-27}
- [ ] [[Реализовать Drag&Drop для звуков]]<br><br>@{2022-11-30}
- [ ] Закончить дизайн интерфейса<br><br>@{2022-12-02}
...
- [ ] Добавить обработку исключений в сцене<br><br>@{2022-12-08}
