...
- [ ] Интерфейс одной сцены в режиме воспроизведения — Добавление и удаление звуков<br><br>@{2022-11-10}
- [ ] Добавить возможность выбирать звуки для сцены из файлов компьютера<br><br>- [ ] Добавить кнопку, открывающую проводник<br>- [ ] Связать выбранный файл и конкретный звук<br><br>@{2022-11-17}
...
- [ ] Параллельный запуск нескольких звуков <br><br>@{2022-11-17}
- [ ] Развёртка БД на PostgreSQL<br><br>@{2022-11-24}
