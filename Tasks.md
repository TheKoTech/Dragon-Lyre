...
- [ ] Интерфейс одной сцены в режиме воспроизведения<br><br>- [x] Один звук<br>- [x] Множество звуков<br>- [x] Отобразить элементы управления<br>- [x] Добавление<br>- [ ] Удаление<br><br>@{2022-11-10}
