...
- [ ] Объяснить, почему мы выбрали React, а не другую библиотеку или фреймворк<br>@{2022-12-22}
...
- [ ] [[Добавить звуковые эффекты в приложение]] <br>@{2022-12-30}
...
- [ ] **Отрефакторить Scene.jsx**<br>Вынести функции по обработке звуков в отдельный файл<br>Сделать их универсальными и чистыми<br>@{2022-12-08}<br>#Дима
...
- [ ] Разобраться со всей основой приложения. Как сделать build? какие зависимости реально нужны в проекте? Как подойти к разработке ДЕСКТОПНОЙ версии?<br>@{2022-12-03}
