...
- [ ] Интерфейс для изменения свойств звуков @{2022-12-08}
- [ ] Возможность создавать свои сцены @{2022-12-18}
- [ ] Интерфейс для добавления звуковых эффектов<br>@{2022-12-27}
...
- [ ] Подключение базы данных для хранения информации о сценах<br><br>@{2022-12-11}
